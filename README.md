...
* 文字版
  * 技术类
    * 通用
      ...
      * [电脑通用知识](https://book.crifan.com/books/computer_tech_summary/website)
      * 编程和开发
        ...
        * [规范](https://www.crifan.com/files/doc/docbook/lan_coding_rule/release/html/lan_coding_rule.html)
        * [通用概念](https://book.crifan.com/books/program_common_logic/website)
        * [基础知识](https://www.crifan.com/files/doc/docbook/soft_dev_basic/release/html/soft_dev_basic.html)
        * [通用知识](https://www.crifan.com/files/doc/docbook/soft_tech_common/release/html/soft_tech_common.html)
      * 推荐工具
        ...
        * 编辑器和IDE
          ...
          * 好用工具
            ...
            * [VSCode](https://book.crifan.com/books/best_editor_vscode/website)
            * [PyCharm](https://book.crifan.com/books/most_intelligent_python_ide_pycharm/website)
        * API
          * [Postman](https://book.crifan.com/books/api_tool_postman/website)
        * 远程连接
          * [SecureCRT](https://www.crifan.com/files/doc/docbook/rec_soft_securecrt/release/html/rec_soft_securecrt.html)
        * [画图工具](https://book.crifan.com/books/best_diagram_tool/website/)
        * [文件对比](https://book.crifan.com/books/file_compare_tool_summary/website)
    * 不同层次
      * 上层：纯软件
        * 通用
          * [HTTP](https://book.crifan.com/books/http_summary/website)
          * API
            * [RESTful](https://book.crifan.com/books/http_restful_api/website)
          * 编程语言
          ...
          * 数据格式
            * JSON
              * [旧](https://www.crifan.com/files/doc/docbook/json_tutorial/release/html/json_tutorial.html)
              * [新](https://book.crifan.com/books/common_data_format_json/website)
          * 版本管理
            * [Git](https://book.crifan.com/books/popular_version_control_git/website)
          * 字符编码
          ...
          * 正则表达式
            * 教程
              * [旧](https://www.crifan.com/files/doc/docbook/regular_expression/release/html/regular_expression.html)
              * [新](https://book.crifan.com/books/super_search_regex/website/)
            * [应用举例](https://book.crifan.com/books/regex_usage_examples/website/)
            * Python
              * re模块
                * [旧](https://www.crifan.com/files/doc/docbook/python_topic_re/release/html/python_topic_re.html)
                * [新](https://book.crifan.com/books/python_regex_re_intro/website)
        * 信息安全
          * [概览](https://book.crifan.com/books/information_security_overview/website)
          ...
          * 移动安全
            * [Android安全](https://book.crifan.com/books/android_app_security_crack/website)
            * [iOS安全](https://book.crifan.com/books/prevent_iphone_hacked_ios_security/website/)
          * 设备安全
            * [工控安全](https://book.crifan.com/books/industrial_control_security_overview/website)
        ...
        * 自动化
          * 工具
            * [Makefile](https://book.crifan.com/books/good_automation_tool_makefile/website)
          * 测试
        ...
        * 爬虫
          * 原理
            * 新
              * [爬虫技术](https://book.crifan.com/books/crawl_your_data_spider_technology/website)
            * 旧
              * [原理和实现](https://www.crifan.com/files/doc/docbook/web_scrape_emulate_login/release/html/web_scrape_emulate_login.html)
          * Python
            * 新
              * [用Python写爬虫](https://book.crifan.com/books/use_python_write_spider/website)
            * 旧
              * [Python抓取网页](https://www.crifan.com/files/doc/docbook/python_topic_web_scrape/release/html/python_topic_web_scrape.html)
            * Python爬虫框架
              * [PySpider](https://book.crifan.com/books/python_spider_pyspider/website)
              * [Scrapy](https://book.crifan.com/books/python_spider_scrapy/website)
          * 相关
            * 内容解析
              * [XPath](https://book.crifan.com/books/xpath_summary/website)
              * BeautifulSoup
                * [旧](https://www.crifan.com/files/doc/docbook/python_topic_beautifulsoup/release/html/python_topic_beautifulsoup.html)
                * [新](https://book.crifan.com/books/html_parse_tool_beautifulsoup/website)
              * [PyQuery](https://book.crifan.com/books/python_html_parse_pyquery/website)
          * 抓包工具
            * [Charles](https://book.crifan.com/books/app_capture_package_tool_charles/website)
        * 编译器
        ...
        * 电子书
          ...
          * 制作工具
            ...
            * [Docbook](https://www.crifan.com/files/doc/docbook/docbook_dev_note/release/html/docbook_dev_note.html)
        * 压缩工具
        ...
        * 通信领域
          * 移动网络
            * [演化](https://book.crifan.com/books/mobile_network_evolution_history/website)
          * 多媒体
      ...
      * 中间：嵌入式
        ...
        * 其他领域
          * [PLC](https://book.crifan.com/books/industrial_automation_plc/website)
          * [现场总线](https://www.crifan.com/files/doc/docbook/fieldbus_intro/release/html/fieldbus_intro.html)
          * 条形码Symbology
      ...
      * 底层：硬件
        ...
        * 芯片
          * [产业链](https://book.crifan.com/books/ic_chip_industry_chain_summary/website)
        * 智能音箱
          * [拆解](https://book.crifan.com/books/smart_speaker_disassemble_summary/website)
  * 非技术
    * 工作类
      * [工作和职业](https://book.crifan.com/books/work_job_summary/website)
      * 工具和软件
        * 协作
      ...
      * 电脑使用
        ...
        * 虚拟机
          ...
          * 常见
            ...
            * VMWare
              * [旧](https://www.crifan.com/files/doc/docbook/vmware_tutorial/release/html/vmware_tutorial.html)
              * [新](https://book.crifan.com/books/popular_virtual_machine_vmware/website/)
      * [买房](https://www.crifan.com/files/doc/docbook/buy_house/release/html/buy_house.html)
      * [生活经验](https://book.crifan.com/books/resident_life_experience_summary/website)
      * [苏州](https://book.crifan.com/books/china_suitable_living_suzhou/website)
    * 娱乐类
      * [羽毛球](https://book.crifan.com/books/all_age_sports_badminton/website)
...
* 关于要有良好的编程习惯和逻辑，才能写出高质量代码：
  ...
  * [计算机语言编程规范](https://www.crifan.com/files/doc/docbook/lan_coding_rule/release/html/lan_coding_rule.html)
...
* 对于计算机，或者说电脑，各种不同类型系统都有一些通用的基础知识：
  * [计算机电脑知识总结](https://book.crifan.com/books/computer_tech_summary/website)
...
* [最智能的Python的IDE：PyCharm](https://book.crifan.com/books/most_intelligent_python_ide_pycharm/website)
...
[文件内容对比工具总结](https://book.crifan.com/books/file_compare_tool_summary/website)
...
* [最流行的版本管理系统：Git](https://book.crifan.com/books/popular_version_control_git/website)
...
* [智能音箱拆解总结](https://book.crifan.com/books/smart_speaker_disassemble_summary/website)

且在拆解期间又去整理了芯片和产业链的相关知识：

* [芯片产业链总结](https://book.crifan.com/books/ic_chip_industry_chain_summary/website)
...
* [硬件和嵌入式通用逻辑知识概念](https://book.crifan.com/books/common_logic_hardware_embedded/website)
...
[工控自动化技术：PLC](https://book.crifan.com/books/industrial_automation_plc/website)
...
* 新教程
  * [主流数据格式：JSON](https://book.crifan.com/books/common_data_format_json/website)
...
* [信息安全概览](https://book.crifan.com/books/information_security_overview/website)
...
* [自动化利器：Makefile](https://book.crifan.com/books/good_automation_tool_makefile/website)
...
* [爬取你要的数据：爬虫技术](https://book.crifan.com/books/crawl_your_data_spider_technology/website)

再去选择合适的语言去写爬虫，比如目前最适合的是Python：

* [如何用Python写爬虫](https://book.crifan.com/books/use_python_write_spider/website)
...
* [主流Python爬虫框架：Scrapy](https://book.crifan.com/books/python_spider_scrapy/website)
...
* (RCS底层所依赖的技术)IMS
  * [多媒体业务核心子系统：IMS](https://book.crifan.com/books/multimedia_core_system_ims/website)
* RCS
  * 概览
...
* [电子书制作利器：GitBook](https://book.crifan.com/books/ebook_system_gitbook/website)
  * 如果想要更简单易用更省心，可以基于我的[Gitbook的模板](https://github.com/crifan/gitbook_template)去制作，生成的效果是[Gitbook演示](https://book.crifan.com/books/gitbook_demo/website)
...
* 旧的
  ...
  * 关于某个特定的模块的总结：
    * BeautifulSoup
      ...
      * 新教程
        * [网页解析利器：BeautifulSoup](https://book.crifan.com/books/html_parse_tool_beautifulsoup/website)
    * PyQuery
      * [HTML解析库Python版jQuery：PyQuery](https://book.crifan.com/books/python_html_parse_pyquery/website)
    * re模块
      * 旧的
...
* [居民生活经验总结](https://book.crifan.com/books/resident_life_experience_summary/website)

针对苏州这个城市，也专门整理了极其详尽的各种资料，尤其是宏观规划，详见：

* [中国宜居城市：苏州](https://book.crifan.com/books/china_suitable_living_suzhou/website)

### 娱乐类

本人常年打羽毛球，有些心得，整理如下，供喜欢羽毛球运动的参考：

* [老少皆宜的运动：羽毛球](https://book.crifan.com/books/all_age_sports_badminton/website)
